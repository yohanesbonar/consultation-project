...
const IcCalendar = ({ width = '24', height = '24' }: IcProps) => (
					...
					<g id="Group_29646" data-name="Group 29646" transform="translate(5.056 9.333)">
						<g id="Group_29648" data-name="Group 29648" transform="translate(0 0)">
							<path
								id="Path_4679"
								data-name="Path 4679"
								d="M1.979-4.3h.78a1.154,1.154,0,0,0,.825-.258.9.9,0,0,0,.268-.684.8.8,0,0,0-.266-.642,1.083,1.083,0,0,0-.732-.23,1.138,1.138,0,0,0-.7.213.663.663,0,0,0-.284.555H.4a1.578,1.578,0,0,1,.311-.958,2.048,2.048,0,0,1,.871-.663,3.109,3.109,0,0,1,1.233-.239,2.911,2.911,0,0,1,1.833.518,1.709,1.709,0,0,1,.663,1.426,1.365,1.365,0,0,1-.309.862,1.985,1.985,0,0,1-.81.6,1.831,1.831,0,0,1,.929.618,1.588,1.588,0,0,1,.306.974A1.743,1.743,0,0,1,4.716-.747a3.04,3.04,0,0,1-1.9.548A2.88,2.88,0,0,1,1.014-.738a1.708,1.708,0,0,1-.7-1.424H1.776a.762.762,0,0,0,.311.628,1.207,1.207,0,0,0,.767.244,1.212,1.212,0,0,0,.818-.255.849.849,0,0,0,.3-.677q0-1.021-1.215-1.021H1.979Z"
								transform="translate(-0.313 7.207)"
								fill="#fff"
							/>
							<path
								id="Path_4680"
								data-name="Path 4680"
								d="M10.465-.111H8.912V-5.465L7.059-4.95V-6.08L10.3-7.118h.167Z"
								transform="translate(-0.893 7.118)"
								fill="#fff"
							/>
						</g>
					</g>
