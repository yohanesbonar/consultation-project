!(function (e, t) {
				...
				if (null != r) {
					...
					try {
						if (((i = (r = r.call(e)).next), 0 === t)) {
							...
							for (
								;
								!(s = (n = i.call(r)).done) && (u.push(n.value), u.length !== t);
								s = !0
							);
					} catch (e) {
						(c = !0), (o = e);
	...
	var ee,
		te =
			((ee = 'undefined' != typeof Uint8Array && A(Uint8Array)),
			function (e) {
			...
			isFormData: function (e) {
				...
				return (
					...
					(('function' == typeof FormData && e instanceof FormData) ||
						(U(e.append) &&
							('formdata' === (t = j(e)) ||
								('object' === t && U(e.toString) && '[object FormData]' === e.toString()))))
				);
			},
	...
	function xe(e, t, r) {
		...
		var l = [],
			h = Object.assign(Se, { defaultVisitor: c, convertValue: s, isVisitable: we });
						...
						ye.forEach(r, function (r, i) {
							!0 ===
								(!(ye.isUndefined(r) || null === r) &&
									o.call(t, r, ye.isString(i) ? i.trim() : i, n, h)) &&
								e(r, n ? n.concat(i) : [i]);
						}),
						l.pop();
				}
	...
	var Pe = (function () {
		...
		Ce =
			('object' === ('undefined' == typeof navigator ? 'undefined' : f(navigator)) &&
				navigator) ||
			void 0,
	...
	var ct,
		...
		lt = function (e) {
			...
			if (
				...
				(n.url = je(at(n.baseURL, n.url), e.params, e.paramsSerializer)),
				c &&
					s.set(
						'Authorization',
						'Basic ' +
										...
										case 11:
											...
											(S = new Request(n, { method: 'POST', body: i, duplex: 'half' })),
												...
												S.body &&
													...
													(k = T[0]),
													(A = T[1]),
													(i = mt(S.body, 65536, k, A)));
										case 15:
											return (
												ye.isString(y) || (y = y ? 'include' : 'omit'),
												(j = 'credentials' in Request.prototype),
												(w = new Request(
													n,
													u(
														u({}, m),
	...
	var jt = function (e) {
		...
		Lt = function (e) {
			for (var t, r, n = (e = ye.isArray(e) ? e : [e]).length, o = {}, i = 0; i < n; i++) {
				var a = void 0;
				if (((r = t = e[i]), !Pt(t) && void 0 === (r = At[(a = String(t)).toLowerCase()])))
